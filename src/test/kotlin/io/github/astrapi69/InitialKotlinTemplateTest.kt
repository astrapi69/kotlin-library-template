...
internal class InitialKotlinTemplateTest {
  ...
  private fun renameToConcreteProject(projectDescription: String) {
    ...
    val gradleProperties =
        FileFactory.newFile(sourceProjectDir, DependenciesInfo.GRADLE_PROPERTIES_FILENAME)
  ...
  companion object {
    ...
    private fun removeTemplateSection(readme: File) {
      val startLineIndex =
          FileSearchExtensions.findLineIndex(readme, "# Template from this project")
      var endLineIndex =
          FileSearchExtensions.findLineIndex(
              readme,
